...
class _DiscussionBottomSheet extends State<DiscussionBottomSheet> {
  ...
  Widget build(BuildContext context) {
    final shortenedText =
    shortenText(discussion?.discussion??"", 40);
    return Padding(
      padding:
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text
                                              (
                                             (list.mentionList.length).toString(),
                                              style:
                                                  AppTextStyle.profileAdmin(),
                                            ),
                                            sbw5,
                                            InkWell(
                                              onTap: () {
                                    ...
                                    list.mentionList.isNotEmpty
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text("Replies...",  style: AppTextStyle
                                                .smallBold(
                                                fontSize: 10,
                                                color: AppColorPalette
                                                    .grey),),
                                      ...
                                      physics: const NeverScrollableScrollPhysics(),
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        list.mentionList
                                                                                ...
                                                                                .date ??
                                                                            "",
                                                                        style: AppTextStyle.mentionTime(),
                                                                      )
                                                                    ],
                                                                  ),
                                                                ],
                                                ...
                                                itemCount: list.mentionList.length),
                                          ],
                                        )
                                        : Container(),
                                  ],
